    ...
    content: [
      {
        ...
        text:
          ...
          "DO NOT retry this exact call — the result was lost due to a transient error (e.g. rate limit). " +
          "Instead, inform the user about the error and ask how to proceed.",
      },
    ],
    isError: true,
    timestamp: Date.now(),
